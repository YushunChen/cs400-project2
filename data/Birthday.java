...
/**
 * This class represents a Birthday object to be contained within the Red Black
 * Tree used for this project. The birthday may be compared to one another based
 * on their relative dates, and they also may be accessed via their long format.
 * 
 * Birthdays may be created with the following two format strings: LONG_PATTERN:
 * "yyyy/MM/dd/HH/mm" SHORT_PATTERN: "yyyy/MM/dd"
 * 
...
public class Birthday implements Comparable<Birthday> {
    ...
    /**
     * Constructor for birthday that initializes the first and last names, and the
     * method also parses the string given for the birthday into the following
     * format:
     * 
     * Long Format for birthday: "yyyy/MM/dd/HH/mm" Short Format for birthday:
     * "yyyy/MM/dd"
     * 
     ...
     * @throws IllegalBirthdayFormatException if the birthday date is not in either
     *                                        of the two correct formats LONG or
     *                                        SHORT
     */
    public Birthday(String stringDate, String firstName, String lastName) throws IllegalBirthdayFormatException {
        ...
        if (stringDate == null) {
            throw new IllegalBirthdayFormatException(
                    "There was in error in reading the format: " + " You cannot use null strings.");
        }
    ...
    /**
     * Determines the format of the string based on the appropriate regular
     * expressions LONG_PATTERN or SHORT_PATTERN.
     * 
     * @param date the string date of the birthday
     * @return the string format of the given date for creating a date format
     * @throws PatternSyntaxException if the given String date matches neither of
     *                                the patterns
     */
    ...
    /**
     * Converts the date of this birthday to its long format for use within the
     * constructor method.
     * 
    ...
    /**
     * A getter method for returning the long version of this birthday's date.
     * 
     ...
     * 
     * "Firstname Lastname: [Weekday] [Month] [Day], [Year] @ [Hour]:[Minute]
     * [AM/PM]"
     * 
     * @return the string representation of this birthday in the above format for
     *         printing.
     */
    ...
    /**
     * Compares two birthdays to one another by date and time. The object is called
     * this and the other argument object is called other. - returns -1 if this
     * occurs BEFORE other - returns 1 if this occurs AFTER other - returns 0 if
     * this occurs at the same time as other
     * 
     * @return the -1 if this is before other, 1 if other occurs before this, 0 if
     *         dates are equal.
     */
    @Override
